...
public class HashTableQuad<Key, Value> implements Map<Key, Value>{
	...
	public HashTableQuad(int capacity, float loadFactor)
	{
		this._entries = new Entry[capacity];
		this._loadFactor = loadFactor;
		this._testLog = new String[capacity];
	}
	public HashTableQuad(int capacity)
	{
		this(capacity, 0.75F);
	}
	...
	{
		return (hashValue + index * index) % this._entries.length;
	}
	@SuppressWarnings("unchecked")
	private void rehash()
	{
